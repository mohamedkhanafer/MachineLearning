...
names(fatalities_pivot_filtered) <- gsub("\\s+", "", names(fatalities_pivot_filtered))
names(fatalities_pivot_filtered) <- gsub("\\(", "", names(fatalities_pivot_filtered))
names(fatalities_pivot_filtered) <- gsub("\\)", "", names(fatalities_pivot_filtered))
names(fatalities_pivot_filtered) <- gsub("\\'", "", names(fatalities_pivot_filtered))
names(fatalities_pivot_filtered) <- gsub("\\*", "", names(fatalities_pivot_filtered))
names(fatalities_pivot_filtered) <- gsub("\\,", "", names(fatalities_pivot_filtered))
...
for(i in names(fatalities_pivot_filtered)){
  
  data<-fatalities_pivot_filtered %>%
    select_(i)
